...
/
-----------------------------------------------------------------------------------------------------
CREATE TABLE AHA_FINANCIAL_INSTITUTION
(
    ID                      NUMBER(18)          NOT NULL,
    NAME                    NVARCHAR2(200)      NOT NULL,
    F_DETAIL_LEDGER_ID      NUMBER(18)          NOT NULL,
    F_PERSON_ID             NUMBER(18)              NULL,
    INSERTED_DATE_TIME      TIMESTAMP(6)            NULL,
    INSERTED_USER_ID        NUMBER(18)              NULL,
    UPDATED_DATE_TIME       TIMESTAMP(6)            NULL,
    UPDATED_USER_ID         NUMBER(18)              NULL
...
ALTER TABLE AHA_FINANCIAL_INSTITUTION ADD (
    CONSTRAINT PK_AHA_FINANCIAL_INSTITUTION PRIMARY KEY (ID)
)
/

ALTER TABLE AHA_FINANCIAL_INSTITUTION ADD CONSTRAINT FK_FI_2_DETAIL_LEDGER FOREIGN KEY (F_DETAIL_LEDGER_ID)
    REFERENCES AHA_DETAIL_LEDGER (ID)
/

ALTER TABLE AHA_FINANCIAL_INSTITUTION ADD CONSTRAINT FK_FI_2_PERSON FOREIGN KEY (F_PERSON_ID)
    REFERENCES AHA_PERSON (ID)
/
-----------------------------------------------------------------------------------------------------
...
(
    ID                      NUMBER(18)          NOT NULL,
    F_FINANCIAL_INSTITUTION_ID NUMBER(18)       NOT NULL,
    F_BANK_ACCOUNT_ID       NUMBER(18)          NOT NULL,
    IS_ACTIVE               NUMBER(1)           NOT NULL,
    INSERTED_DATE_TIME      TIMESTAMP(6)            NULL,
    INSERTED_USER_ID        NUMBER(18)              NULL,
...
ALTER TABLE AHA_FINANCIAL_INSTITUTION_BANK_ACCOUNT ADD CONSTRAINT FK_FIBA_2_FI FOREIGN KEY (F_FINANCIAL_INSTITUTION_ID)
    REFERENCES AHA_FINANCIAL_INSTITUTION (ID)
/
-----------------------------------------------------------------------------------------------------
