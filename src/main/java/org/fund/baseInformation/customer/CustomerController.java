...
public class CustomerController {
    ...
    public List<CustomerBankAccountDto> getCustomerBankAccountList(@PathVariable("customerId") @ValidateField(fieldName = "id", entityClass = Customer.class) Long customerId) {
